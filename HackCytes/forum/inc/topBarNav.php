  ...
  <div class="container px-4 px-lg-5 ">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
        <li class="nav-item"><a class="nav-link text-white" aria-current="page" href="../first.html">Home</a></li>
        <li class="nav-item"><a class="nav-link text-white" aria-current="page" href="../Labs">Labs</a></li>
      ...
      <div class="d-flex align-items-center">
        ...
        <?php else : ?>
          ...
          <a class="font-weight-bolder text-light pr-3 mx-2 text-decoration-none border-right" href="./admin">Admin Login</a>
        <?php endif; ?>
      </div>
    </div>
  </div>
