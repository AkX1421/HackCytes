            ...
            <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                <div class="input-group input-group-lg" id="search-field">
                    ...
                    <div class="input-group-append">
                        <span class="input-group-text rounded-pill bg-white"><i class="fa fa-search"></i></span>
                    </div>
                </div>
            </div>
        </div>
        <div class="row row-cols-xl-1 row-cols-md-1 row-cols-sm-1 gx-2 gy-2">
            <?php 
            ...
            <div class="col post-item">
                <a href="./?p=posts/view_post&id=<?= $row['id'] ?>" class="card rounded-1 shadow text-decoration-none text-reset">
                    <div class="card-body">
                        ...
                        <div class="card-text truncate-3 text-light text-sm" ><?= strip_tags($row['content']) ?></div>
                        <div class="mb-2 text-right">
                            <small class="text-light"><i><?= date("Y-m-d h:i A", strtotime($row['date_created'])) ?></i></small>
                        </div>
                    </div>
                </a>
            </div>
