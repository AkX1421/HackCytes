...
require_once HVA_WEB_PAGE_TO_ROOT . "vulnerabilities/javascript/source/{$vulnerabilityFile}";
...
$page[ 'body' ] .= "
	...
	<ul>
		<li>" . hackcytesExternalLinkUrlGet( 'https://www.w3schools.com/js/' ) . "</li>
		<li>" . hackcytesExternalLinkUrlGet( 'https://www.youtube.com/watch?v=cs7EQdWO5o0&index=17&list=WL' ) . "</li>
		<li>" . hackcytesExternalLinkUrlGet( 'https://ponyfoo.com/articles/es6-proxies-in-depth' ) . "</li>
	</ul>
