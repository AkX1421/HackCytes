<div class="body_padded">
	...
	<td><div id="code">
		...
		<p>The medium level uses a form of SQL injection protection, with the function of
			"<?php echo hackcytesExternalLinkUrlGet( 'https://secure.php.net/manual/en/function.mysql-real-escape-string.php', 'mysql_real_escape_string()' ); ?>".
	...
	<p>Reference: <?php echo hackcytesExternalLinkUrlGet( 'https://owasp.org/www-community/attacks/Blind_SQL_Injection' ); ?></p>
</div>
