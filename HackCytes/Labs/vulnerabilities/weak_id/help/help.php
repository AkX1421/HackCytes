<div class="body_padded">
	...
	<td><div id="code">
		...
		<h3>Objective</h3>
		<p>This module uses four different ways to set the hackcytesSession cookie value, the objective of each level is to work out how the ID is generated and then infer the IDs of other system users.</p>
	...
	<p>Reference: <?php echo hackcytesExternalLinkUrlGet( 'https://owasp.org/www-project-web-security-testing-guide/latest/4-Web_Application_Security_Testing/06-Session_Management_Testing/01-Testing_for_Session_Management_Schema', 'WSTG - Session Management Schema' ); ?></p>
	<p>Reference: <?php echo hackcytesExternalLinkUrlGet( 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html', 'OWASP Cheat Sheet - Session Management' ); ?></p>
</div>
