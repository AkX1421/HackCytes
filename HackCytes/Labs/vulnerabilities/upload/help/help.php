<div class="body_padded">
	...
	<td><div id="code">
		...
		<h3>Objective</h3>
		<p>Execute any PHP function of your choosing on the target system (such as <?php echo hackcytesExternalLinkUrlGet( 'https://secure.php.net/manual/en/function.phpinfo.php', 'phpinfo()' ); ?>
			or <?php echo hackcytesExternalLinkUrlGet( 'https://secure.php.net/manual/en/function.system.php', 'system()' ); ?>) thanks to this file upload vulnerability.</p>
	...
	<p>Reference: <?php echo hackcytesExternalLinkUrlGet( 'https://owasp.org/www-community/vulnerabilities/Unrestricted_File_Upload' ); ?></p>
</div>
