<div class="body_padded">
	...
	<td><div id="code">
		...
		<pre>Spoiler: <span class="spoiler"><?php echo hackcytesExternalLinkUrlGet( 'https://secure.php.net/manual/en/function.trim.php', 'trim()' ); ?>
	...
	<p>Reference: <?php echo hackcytesExternalLinkUrlGet( 'https://owasp.org/www-community/attacks/Command_Injection' ); ?></p>
</div>
