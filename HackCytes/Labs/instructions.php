...
require_once HVA_WEB_PAGE_TO_ROOT . 'hva/includes/Parsedown.php';
...
$docs = array(
	...
	'PHPIDS-license' => array( 'type' => 'markdown', 'legend' => 'PHPIDS License', 'file' => hackcytes_WEB_PAGE_TO_PHPIDS . 'LICENSE' ),
);
...
$instructions = file_get_contents( HVA_WEB_PAGE_TO_ROOT.$readFile );
...
function urlReplace( $matches ) {
	return hackcytesExternalLinkUrlGet( $matches[1] );
}
