...
if( isset( $_POST[ 'create_db' ] ) ) {
	...
	if( $DBMS == 'MySQL' ) {
		include_once HVA_WEB_PAGE_TO_ROOT . 'hva/includes/DBMS/MySQL.php';
	}
	elseif($DBMS == 'PGSQL') {
		// include_once HVA_WEB_PAGE_TO_ROOT . 'hva/includes/DBMS/PGSQL.php';
		hackcytesMessagePush( 'PostgreSQL is not yet fully supported.' );
		hackcytesPageReload();
	}
	else {
		hackcytesMessagePush( 'ERROR: Invalid database selected. Please review the config file syntax.' );
		hackcytesPageReload();
	}
}
...
<div class=\"body_padded\">
	<h1>Database Setup <img src=\"" . HVA_WEB_PAGE_TO_ROOT . "hva/images/spanner.png\" /></h1>
	...
	{$MYSQL_PORT}<br />
	<br />
	{$hackcytesRecaptcha}<br />
	<br />
	{$hackcytesUploadsWrite}<br />
	{$hackcytesPHPWrite}<br />
	<br />
	<br />
	{$bakWritable}
	<br />
